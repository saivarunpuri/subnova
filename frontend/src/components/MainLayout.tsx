          ...
          <div className="absolute inset-0 z-10 pointer-events-none flex min-w-0">
            ...
            <main className="flex-1 relative min-w-0">
              ...
              {['entertainment', 'education', 'music', 'productivity', 'creator', 'discover'].includes(activeSpace) && (
                <div className={`pointer-events-auto lg:pointer-events-none relative w-full h-full p-4 sm:p-6 lg:p-8 pt-24 sm:pt-28 pb-32 sm:pb-40 flex items-start sm:items-center justify-center lg:justify-end lg:pr-24 overflow-y-auto custom-scrollbar custom-scrollbar-${activeSpace}`}>
